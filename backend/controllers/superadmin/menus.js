...
module.exports = {
    ...
    list: async (req, res) => {
        try {
            ...
            res.render('superadmin/menus/list', { layout: false, menus: data, roles: role, role: req.session.passport.user.role });
        } catch (err) {
    ...
    create: async (req, res) => {
        ...
        if (req.method == 'GET' && req.url == '/create') {
            ...
            res.render('superadmin/menus/create', { layout: false, parents: await parents, roles: roles });
        } else {
    ...
    edit: async (req, res) => {
        ...
        if (req.method == 'GET' && req.url.includes('/edit')) {
            ...
            let roles = await (await control.find('roles', { where: {} }));
            res.render('superadmin/menus/edit', { layout: false, menu: menu, roles: roles, parents: parents });
        } else {

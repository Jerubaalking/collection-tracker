...
const { roles, languages } = require('../../database/models/module_exporter');
// const distributors = require('../../database/models/software_dealers');
...
router.get('/', isLoggedIn, async (req, res) => {
    ...
    let distributor_count = await distributors.count();
    ...
    res.render('superadmin_home', {
        ...
        menus: await main, sub_menu: await sub, businesses: await business, customer_count: customer_count, store_count: store_count, business_count: business_count, distributor_count: distributor_count
    });
});
